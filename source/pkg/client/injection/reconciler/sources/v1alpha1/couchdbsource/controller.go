...
import (
	...
	versionedscheme "knative.dev/eventing-couchdb/source/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-couchdb/source/pkg/client/injection/client"
	couchdbsource "knative.dev/eventing-couchdb/source/pkg/client/injection/informers/sources/v1alpha1/couchdbsource"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.CouchDbSource"),
	)
