...
import (
	...
	fake "knative.dev/eventing-couchdb/source/pkg/client/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/eventing-couchdb/source/pkg/client/clientset/versioned/fake.Clientset from context.")
	}
